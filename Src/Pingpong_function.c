...
{
  if (L_points & 1) HAL_GPIO_WritePin(LED1_GPIO_Port, LED1_Pin, GPIO_PIN_SET);   
         else HAL_GPIO_WritePin(LED1_GPIO_Port, LED1_Pin, GPIO_PIN_RESET); 
         
         if (L_points & 2) HAL_GPIO_WritePin(LED2_GPIO_Port, LED2_Pin, GPIO_PIN_SET);   
         else HAL_GPIO_WritePin(LED1_GPIO_Port, LED2_Pin, GPIO_PIN_RESET); 
         
         if (L_points & 4) HAL_GPIO_WritePin(LED3_GPIO_Port, LED3_Pin, GPIO_PIN_SET);   
         else HAL_GPIO_WritePin(LED1_GPIO_Port, LED3_Pin, GPIO_PIN_RESET); 
         
         if (L_points & 8) HAL_GPIO_WritePin(LED4_GPIO_Port, LED4_Pin, GPIO_PIN_SET);   
         else HAL_GPIO_WritePin(LED1_GPIO_Port, LED4_Pin, GPIO_PIN_RESET); 
         
         if (R_points & 8) HAL_GPIO_WritePin(LED5_GPIO_Port, LED5_Pin, GPIO_PIN_SET);   
         else HAL_GPIO_WritePin(LED1_GPIO_Port, LED5_Pin, GPIO_PIN_RESET); 
         
         if (R_points & 4) HAL_GPIO_WritePin(LED6_GPIO_Port, LED6_Pin, GPIO_PIN_SET);   
         else HAL_GPIO_WritePin(LED1_GPIO_Port, LED6_Pin, GPIO_PIN_RESET); 
         
         if (R_points & 2) HAL_GPIO_WritePin(LED7_GPIO_Port, LED7_Pin, GPIO_PIN_SET);   
         else HAL_GPIO_WritePin(LED1_GPIO_Port, LED7_Pin, GPIO_PIN_RESET); 
         
         if (R_points & 1) HAL_GPIO_WritePin(LED8_GPIO_Port, LED8_Pin, GPIO_PIN_SET);   
